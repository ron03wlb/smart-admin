...
> **目標讀者**: 架構師、後端開發
> **業務需求**: [Bonus_Calculation_Requirements.md](../../requirements/04_Promotions_VIP/01_Bonus_Calculation_Requirements.md)
> **最後同步**: 2026-02-08
> **來源版本**: 1.0.0
...
### 技術架構
- [活動引擎架構索引](README.md)
- [風控系統架構](../05_Risk_Engine/01_Risk_System_Architecture.md)

### 業務需求
- [獎金計算業務需求](../../requirements/04_Promotions_VIP/01_Bonus_Calculation_Requirements.md)
