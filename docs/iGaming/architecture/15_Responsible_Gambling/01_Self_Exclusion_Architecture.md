...
> **業務需求**: [Self_Exclusion_Requirements.md](../../requirements/15_Responsible_Gambling/01_Self_Exclusion_Requirements.md)
...
- [Self_Exclusion_Requirements.md](../../requirements/15_Responsible_Gambling/01_Self_Exclusion_Requirements.md) — 業務需求
- [Deposit_Loss_Limits_Architecture.md](02_Deposit_Loss_Limits_Architecture.md) — 存款及虧損限額架構
