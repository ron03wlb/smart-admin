...
> **業務需求**: [Affordability_Requirements.md](../../requirements/15_Responsible_Gambling/04_Affordability_Requirements.md)
...
- [Affordability_Requirements.md](../../requirements/15_Responsible_Gambling/04_Affordability_Requirements.md) — 業務需求
- [Self_Exclusion_Architecture.md](01_Self_Exclusion_Architecture.md) — 自我排除架構
- [Deposit_Loss_Limits_Architecture.md](02_Deposit_Loss_Limits_Architecture.md) — 限額架構
- [Session_Protection_Architecture.md](03_Session_Protection_Architecture.md) — Session 保護
