...
> **業務需求**: [QA 標準需求](../../requirements/09_Infrastructure_Requirements/01_QA_Standards_Requirements.md)
...
- [性能監控](./12_Performance_Monitoring.md) — APM 監控與告警架構
- [部署架構](./08_Deployment_Architecture.md) — 部署架構與 DevOps 規範
- [系統維護](./10_Maintenance_Architecture.md) — 系統維護與優雅停機架構
