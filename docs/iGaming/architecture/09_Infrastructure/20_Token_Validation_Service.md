...
| 文檔 | 內容 |
|------|------|
| [Token Validation Architecture](./19_Token_Validation_Architecture.md) | 架構概覽、服務職責、API 設計 |
| [Token Cache Performance](./21_Token_Cache_Performance.md) | 驗證流程、三層緩存策略 |
| [Token Edge Deployment](./22_Token_Edge_Deployment.md) | 重放防護、限流熔斷、高可用、監控 |
