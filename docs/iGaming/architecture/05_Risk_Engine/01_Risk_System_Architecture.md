...
> **業務需求**: [Risk_Strategy_Overview.md](../../requirements/05_Risk_Compliance/01_Risk_Strategy_Overview.md)
...
- 錢包架構 *(規劃中)* - 餘額監控
- [Turnover_Calculation_Logic.md](../03_Game_Integration/04_Turnover_Calculation_Logic.md) - Layer 2 整合

### 技術參考（Technical Reference）
- [Gateway_Core.md](../09_Infrastructure/01_Gateway_Core.md) - API 速率限制、熔斷器
- [Stream_Processing_Architecture.md](../09_Infrastructure/15_Stream_Processing_Architecture.md) - Kafka/Flink 模式
