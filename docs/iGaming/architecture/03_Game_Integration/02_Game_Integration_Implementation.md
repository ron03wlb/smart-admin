...
> **Audience**: 架構師、後端開發人員
> **Business Requirements**: [Game Integration Requirements](../../requirements/03_Gaming_Operations/02_Game_Integration_Requirements.md)
...
> **相關參考**: [Game_Integration_Security.md](03_Game_Integration_Security.md) — Token 完整性驗證、[Risk_System_Architecture.md](../05_Risk_Engine/01_Risk_System_Architecture.md) — 遊戲 RTP 異常偵測
...
- [Game Integration Requirements](../../requirements/03_Gaming_Operations/02_Game_Integration_Requirements.md) - 業務需求
- [Turnover Calculation Logic](./04_Turnover_Calculation_Logic.md) - 有效投注額技術設計
