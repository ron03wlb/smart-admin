...
### 業務邏輯參考
- [04-01 活動系統設計](../04_Activity_Center/04-04_Activity_Bonus.md) - 活動多語言內容
- [08-02 Banner 管理](./11-02_Banner_&_Announcement.md) - 橫幅多語言
- [11-01 客服中台設計](../13_Customer_Service/13-01_CS_Platform_Design.md) - 通知模板本地化

### 技術架構參考
- [12-05 API設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - API規範
- [09-03 數據安全標準](../12_System_Security/12-03_Data_Security_Standard.md) - JSONB 加密
