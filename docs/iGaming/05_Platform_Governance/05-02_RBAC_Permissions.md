...
### 核心依賴
- [07-01 系統層級架構](../05_Platform_Governance/05-01_Multi_Tenant.md) - 多租戶架構、層級設計
...
- [12-03 網關架構](../07_Technical_Infrastructure/07-02-01_Gateway_Core.md) - API 權限驗證

### 延伸閱讀
- [07-02 租戶配置管理](../07_Platform_Management/07-02_Tenant_Configuration.md) - 商戶權限配置
- [11-01 客服平台設計](../06_Analytics_Operations/06-02_Customer_Service.md) - 客服權限管理
