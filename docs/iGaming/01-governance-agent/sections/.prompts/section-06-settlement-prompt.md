...
Generate content for section `section-06-settlement` (filename: `section-06-settlement.md`).
...
for `section-06-settlement` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/section-06-settlement.md`
