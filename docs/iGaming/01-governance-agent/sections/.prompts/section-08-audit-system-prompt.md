...
Generate content for section `section-08-audit-system` (filename: `section-08-audit-system.md`).
...
for `section-08-audit-system` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/section-08-audit-system.md`
