...
Generate content for section `section-05-commission-engine` (filename: `section-05-commission-engine.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/claude-plan.md` - Full implementation plan
2. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-commission-engine` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/section-05-commission-engine.md`
