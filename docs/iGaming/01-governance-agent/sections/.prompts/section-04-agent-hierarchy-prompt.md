...
Generate content for section `section-04-agent-hierarchy` (filename: `section-04-agent-hierarchy.md`).
...
for `section-04-agent-hierarchy` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/section-04-agent-hierarchy.md`
