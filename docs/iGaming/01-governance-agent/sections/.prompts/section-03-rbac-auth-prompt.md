...
Generate content for section `section-03-rbac-auth` (filename: `section-03-rbac-auth.md`).
...
for `section-03-rbac-auth` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\01-governance-agent/sections/section-03-rbac-auth.md`
