...
| 2 | [01-02 Wallet_Architecture](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md) | §2 錢包架構 | 15 分鐘 | 多錢包設計、鎖定邏輯 |
| 3 | [01-02 Wallet_Architecture](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md) | §3 並發控制 | 10 分鐘 | Redis Lua 原子性 |
| 4 | [01-04 Transaction_Flow](../01_Core_Financial_Loop_NEW/01-04_Transaction_Flow.md) | §3 事件驅動 | 12 分鐘 | Outbox Pattern |
...
| 順序 | 文檔 | 章節 | 閱讀時間 | 重點內容 |
|------|------|------|---------|---------|
| 1 | [01-03 Payment_Integration](../01_Core_Financial_Loop_NEW/01-03_Payment_Integration.md) | §2 對接流程 | 10 分鐘 | 入金/出金 API |
| 2 | [07-03-02 Authentication](../07_Technical_Infrastructure_NEW/07-03-02_Authentication.md) | §2 HMAC 簽名 | 8 分鐘 | 簽名驗證機制 |
| 3 | [01-04 Transaction_Flow](../01_Core_Financial_Loop_NEW/01-04_Transaction_Flow.md) | §2 交易狀態機 | 10 分鐘 | 支付狀態轉換 |
...
| 2 | [01-05 Withdrawal_Risk](../01_Core_Financial_Loop_NEW/01-05_Withdrawal_Risk.md) | §4 風控流程 | 15 分鐘 | 規則引擎設計 |
...
| 順序 | 文檔 | 章節 | 閱讀時間 | 重點內容 |
|------|------|------|---------|---------|
| 1 | [01-06 Reconciliation](../01_Core_Financial_Loop_NEW/01-06_Reconciliation.md) | §2 對帳模型 | 15 分鐘 | 三方對帳邏輯 |
| 2 | [02-03 Turnover_Calculation](../02_Game_Operations_NEW/02-03_Turnover_Calculation.md) | §2 三層驗證 | 10 分鐘 | 流水對帳 |
...
| 2 | [02-02 Seamless_Wallet_API](../02_Game_Operations_NEW/02-02_Seamless_Wallet_API.md) | §4 Token 驗證 | 10 分鐘 | 安全機制 |
| 3 | [02-02 Seamless_Wallet_API](../02_Game_Operations_NEW/02-02_Seamless_Wallet_API.md) | §4.3 冪等性設計 | 8 分鐘 | 請求去重 |
| 4 | [02-04 Game_Provider_Cases](../02_Game_Operations_NEW/02-04_Game_Provider_Cases.md) | 全文 | 15 分鐘 | 廠商案例 |
