...
👉 **深入閱讀**: [05-01 多租戶架構 §2.1](../05_Platform_Governance_NEW/05-01_Multi_Tenant_Arch.md#tenant-context-注入)
...
👉 **深入閱讀**: [01-02 錢包架構 §2.1](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md#錢包初始化)
...
👉 **深入閱讀**: [01-01 玩家生命週期 §3](../01_Core_Financial_Loop_NEW/01-01_Player_Lifecycle.md#kyc-驗證)
...
- 🔗 [01-01 玩家生命週期](../01_Core_Financial_Loop_NEW/01-01_Player_Lifecycle.md)
- 🔗 [05-01 多租戶架構](../05_Platform_Governance_NEW/05-01_Multi_Tenant_Arch.md)
- 🔗 [05-05 數據安全（身份證加密）](../05_Platform_Governance_NEW/05-05_Data_Security.md)
...
👉 **深入閱讀**: [02-02 Seamless Wallet API §4.2](../02_Game_Operations_NEW/02-02_Seamless_Wallet_API.md#token-驗證流程) ⭐ SSOT
...
👉 **深入閱讀**: [02-02 Seamless Wallet API §4.3](../02_Game_Operations_NEW/02-02_Seamless_Wallet_API.md#冪等性設計) ⭐ SSOT
...
👉 **深入閱讀**: [01-02 錢包架構 §2.3](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md#可下注餘額計算) ⭐ SSOT
...
👉 **深入閱讀**: [02-01 遊戲集成](../02_Game_Operations_NEW/02-01_Game_Integration.md)

### 2.5 相關文檔

- 🔗 [02-02 Seamless Wallet API](../02_Game_Operations_NEW/02-02_Seamless_Wallet_API.md) ⭐
- 🔗 [01-02 錢包架構](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md) ⭐
- 🔗 [07-03-02 API 認證](../07_Technical_Infrastructure_NEW/07-03-02_Authentication.md)
...
👉 **深入閱讀**: [03-01 Bonus 引擎 §2](../03_Promotion_System_NEW/03-01_Bonus_Engine.md#bonus-計算)
...
👉 **深入閱讀**: [02-03 流水計算 §3.1](../02_Game_Operations_NEW/02-03_Turnover_Calculation.md#有效投注算法) ⭐ SSOT
...
👉 **深入閱讀**: [03-03 流水規則 §3.2](../03_Promotion_System_NEW/03-03_Wagering_Rules.md#bonus-轉現金)
...
- 🔗 [03-01 Bonus 引擎](../03_Promotion_System_NEW/03-01_Bonus_Engine.md)
- 🔗 [03-03 流水規則](../03_Promotion_System_NEW/03-03_Wagering_Rules.md)
- 🔗 [02-03 流水計算](../02_Game_Operations_NEW/02-03_Turnover_Calculation.md) ⭐
...
👉 **深入閱讀**: [01-02 錢包架構 §2.4](../01_Core_Financial_Loop_NEW/01-02_Wallet_Architecture.md#資金鎖定邏輯)
...
👉 **深入閱讀**: [01-05 出金風控 §4.3](../01_Core_Financial_Loop_NEW/01-05_Withdrawal_Risk.md#saga-補償)
...
- 🔗 [01-05 出金風控](../01_Core_Financial_Loop_NEW/01-05_Withdrawal_Risk.md) ⭐
- 🔗 [04-01 風控引擎](../04_Risk_Control_NEW/04-01_Risk_Engine.md) ⭐
- 🔗 [05-06 審批工作流](../05_Platform_Governance_NEW/05-06_Approval_Workflow.md)
...
- 🔗 [02-03 流水計算](../02_Game_Operations_NEW/02-03_Turnover_Calculation.md) ⭐
- 🔗 [01-06 對帳系統](../01_Core_Financial_Loop_NEW/01-06_Reconciliation.md)
- 🔗 [06-01 報表 BI](../06_Analytics_Operations_NEW/06-01_Reporting_BI.md)
...
- 🔗 [05-01 多租戶架構](../05_Platform_Governance_NEW/05-01_Multi_Tenant_Arch.md) ⭐
- 🔗 [05-03 RBAC 安全](../05_Platform_Governance_NEW/05-03_RBAC_Security.md)
- 🔗 [07-02 API 網關](../07_Technical_Infrastructure_NEW/07-02_Gateway_Architecture/)
