...
- [09-04 審批工作流系統](../05_Platform_Governance/05-04_Approval_Workflow.md) - 高危操作審批

### 技術參考
- [12-03 網關架構](../07_Technical_Infrastructure/07-02-01_Gateway_Core.md) - 配置同步機制
- [09-02 審計日誌系統](../05_Platform_Governance/05-03_Audit_Log.md) - 配置變更記錄
