...
> **MIGRATED FROM**:
> - 10-01_Reporting_Architecture.md (470 lines)
> - 07-04_Data_Pipeline_Architecture.md (data pipeline sections, ~250 lines)
>
> **Version**: 2.0.0
...
- [04-01 風控系統](../04_Risk_Control/04-01_Risk_Engine.md) - 風控報表數據來源

### Analytics & Operations
- [06-02 客戶服務](../06_Analytics_Operations/06-02_Customer_Service.md) - 客服 BI 整合
- [06-03 第三方整合](../06_Analytics_Operations/06-03_Third_Party_Integration.md) - 數據分析工具整合

### Technical Infrastructure
- [07-02 網關架構](../07_Technical_Infrastructure/07-02_Gateway_Architecture.md) - API 速率限制
- [07-03 API 設計標準](../07_Technical_Infrastructure/07-03_API_Design_Standard.md) - RESTful 報表 API
...
**遷移歷史**:
- 從 10-01_Reporting_Architecture.md (470 lines) 合併報表與 BI 架構
- 從 07-04_Data_Pipeline_Architecture.md 合併數據管道架構（250 lines）
- 新增實時 vs 批次處理決策內容
