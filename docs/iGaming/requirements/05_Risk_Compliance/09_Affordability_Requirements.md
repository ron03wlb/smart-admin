...
> **Related Architecture**: [Affordability_Implementation.md](../../architecture/05_Risk_Engine/09_Affordability_Implementation.md)
...
→ **[Affordability Assessment Implementation](../../architecture/05_Risk_Engine/09_Affordability_Implementation.md)** - Light/enhanced/full 評估演算法、銀行 API 整合、收入驗證工作流程、限額執行機制和即時監控儀表板
