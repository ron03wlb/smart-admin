...
> **相關架構**: [i18n Architecture](../../architecture/11_Frontend/07_i18n_Localization.md), [Dynamic Content Localization](../../architecture/11_Frontend/08_Dynamic_Content_Localization.md), [Localization Workflow](../../architecture/11_Frontend/09_Localization_Workflow.md), [Localization API](../../architecture/11_Frontend/10_Localization_API.md)
> **最後同步**: 2026-02-09
