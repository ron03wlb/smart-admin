...
> **相關架構**: [System_Overview.md](../../architecture/00_Overview/01_System_Overview.md)
> **最近同步**: 2026-02-08
...
→ **[系統總覽 - 技術實作](../../architecture/00_Overview/01_System_Overview.md)** - 詳細系統架構、模組依賴、資料流程圖及技術基礎設施規格
