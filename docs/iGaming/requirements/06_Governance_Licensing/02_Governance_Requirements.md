...
> **目標讀者**: 高階主管、產品經理、合規官
> **相關架構**: [Governance_Implementation.md](../../architecture/06_Platform_Core/02_Governance_Implementation.md)
> **最後同步**: 2026-02-08
...
→ **[Encryption Algorithm Selection](../../architecture/06_Platform_Core/02_Governance_Implementation.md#encryption-algorithms)** — 有關認可演算法詳情，請參閱架構層
