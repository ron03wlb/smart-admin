...
> **Related Architecture**: [Promotion_Implementation.md](../../architecture/04_Activity_Engine/02_Promotion_Implementation.md)
...
→ **[Promotion Implementation Architecture](../../architecture/04_Activity_Engine/02_Promotion_Implementation.md)** - Promotion rule engine, VIP tier calculation algorithms, benefit activation workflows, grace period management, and points expiration scheduling
