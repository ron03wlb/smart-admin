...
Generate content for section `section-07-payment-gateway` (filename: `section-07-payment-gateway.md`).
...
for `section-07-payment-gateway` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/section-07-payment-gateway.md`
