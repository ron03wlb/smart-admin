...
Generate content for section `section-03-wallet-transaction` (filename: `section-03-wallet-transaction.md`).
...
for `section-03-wallet-transaction` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/section-03-wallet-transaction.md`
