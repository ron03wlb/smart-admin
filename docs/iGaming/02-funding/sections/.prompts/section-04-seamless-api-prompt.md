...
Generate content for section `section-04-seamless-api` (filename: `section-04-seamless-api.md`).
...
for `section-04-seamless-api` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/section-04-seamless-api.md`
