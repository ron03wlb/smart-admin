...
Generate content for section `section-05-wallet-reconciliation` (filename: `section-05-wallet-reconciliation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/claude-plan.md` - Full implementation plan
2. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-wallet-reconciliation` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/section-05-wallet-reconciliation.md`
