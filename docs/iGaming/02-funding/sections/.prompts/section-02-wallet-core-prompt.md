...
Generate content for section `section-02-wallet-core` (filename: `section-02-wallet-core.md`).
...
for `section-02-wallet-core` to understand what this section should contain.
...
`C:\Users\ron.chang\obsidian_daily\200_專案\IGaming\02-funding/sections/section-02-wallet-core.md`
