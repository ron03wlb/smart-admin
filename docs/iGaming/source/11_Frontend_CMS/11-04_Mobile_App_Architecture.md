...
### 前置依賴
- [08-01 前端佈局引擎](./11-01_Frontend_Layout_Engine.md) - 組件設計規範
- [08-05 本地化系統](./11-07_i18n_Localization.md) - 多語言實作

### 技術參考
- [12-03 網關架構](../09_Technical_Infrastructure/09-02-01_Gateway_Core.md) - API 限流與安全
