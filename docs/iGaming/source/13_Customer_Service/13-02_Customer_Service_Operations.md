...
> **MIGRATED FROM**: 13-01_CS_Platform_Design.md (Phase 4 Module Merge)
> **Version**: 2.0.0
...
💡 **SSOT Marker**: 風險評分邏輯詳見 **[05-01 風控系統](../05_Risk_Control/05-01_Risk_Framework.md)**
...
- **[05-01 風控系統](../05_Risk_Control/05-01_Risk_Framework.md)** - 風險評分、異常檢測

### 技術基礎設施
- **[07-02 網關架構](../09_Technical_Infrastructure/09-02-01_Gateway_Core.md)** - WebSocket 即時通訊
- **[07-03 API 設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md)** - RESTful API 規範

### Analytics & Operations
- **[06-01 報表與 BI](../08_Analytics_BI/08-01_Reporting_BI.md)** - 客服績效分析報表
- **[06-03 第三方整合](../14_Third_Party_Integration/14-01_Third_Party_Integration.md)** - Telegram/WhatsApp 整合
