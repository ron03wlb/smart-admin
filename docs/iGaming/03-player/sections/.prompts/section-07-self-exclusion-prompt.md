...
Generate content for section `section-07-self-exclusion` (filename: `section-07-self-exclusion.md`).
...
for `section-07-self-exclusion` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-07-self-exclusion.md`
