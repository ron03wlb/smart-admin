...
Generate content for section `section-02-lifecycle-statemachine` (filename: `section-02-lifecycle-statemachine.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/claude-plan.md` - Full implementation plan
2. `C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-lifecycle-statemachine` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-02-lifecycle-statemachine.md`
