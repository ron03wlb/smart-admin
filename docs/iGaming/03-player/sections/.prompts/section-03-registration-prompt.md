...
Generate content for section `section-03-registration` (filename: `section-03-registration.md`).
...
for `section-03-registration` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-03-registration.md`
