...
Generate content for section `section-06-segmentation` (filename: `section-06-segmentation.md`).
...
for `section-06-segmentation` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-06-segmentation.md`
