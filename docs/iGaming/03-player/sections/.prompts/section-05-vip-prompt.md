...
Generate content for section `section-05-vip` (filename: `section-05-vip.md`).
...
for `section-05-vip` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-05-vip.md`
