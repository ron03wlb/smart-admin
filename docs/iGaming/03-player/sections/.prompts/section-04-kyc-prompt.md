...
Generate content for section `section-04-kyc` (filename: `section-04-kyc.md`).
...
for `section-04-kyc` to understand what this section should contain.
...
`C:\Workspace\open_source\smart-admin\docs\iGaming\03-player/sections/section-04-kyc.md`
