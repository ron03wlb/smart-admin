...
> **業務需求（Business Requirements）**: [Payment_Operations.md](../../requirements/02_Financial_Operations/03_Payment_Operations.md)
...
- [Payment_Operations.md](../../requirements/02_Financial_Operations/03_Payment_Operations.md) - 業務規則、PSP 矩陣、審批閾值

### 技術依賴（Technical Dependencies）
- [Financial_Implementation.md](04_Financial_Implementation.md) - 錢包系統、SAGA 補償
- [Seamless_Wallet_Technical.md](03_Seamless_Wallet_Technical.md) - 錢包 API 整合
