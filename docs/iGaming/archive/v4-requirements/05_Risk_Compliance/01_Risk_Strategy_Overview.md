...
> **目標讀者**: 高階主管、合規官、業務分析師
> **相關架構**: [Risk_System_Architecture.md](../../architecture/05_Risk_Engine/01_Risk_System_Architecture.md)
> **最後同步**: 2026-02-08
> **來源版本**: 4.0.0
...
- [02-03 Reconciliation Requirements](../02_Financial_Operations/04_Reconciliation_Requirements.md) - 餘額驗證
- [05_Risk_Compliance/KYC_AML_Requirements](03_KYC_AML_Requirements.md) - KYC 程序
...
→ **[Risk System Architecture](../../architecture/05_Risk_Engine/01_Risk_System_Architecture.md)** - 五層風險控制架構、即時偵測引擎、規則配置系統、ML 模型整合和跨模組編排
