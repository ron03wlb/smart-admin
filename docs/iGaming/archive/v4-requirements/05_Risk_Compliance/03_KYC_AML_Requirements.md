...
> **目標讀者**: 高管、合規官、產品經理
> **相關架構**: [KYC_Verification_API.md](../../architecture/05_Risk_Engine/06_KYC_Verification_API.md)
> **最後同步**: 2026-02-08
> **來源版本**: 4.0.0
...
→ **[KYC Verification API](../../architecture/05_Risk_Engine/06_KYC_Verification_API.md)** - KYC/AML 驗證工作流、OCR 身份文件處理、第三方供應商整合（Jumio/Onfido）、PEP/制裁清單篩查、活體偵測和審計追蹤實施
