...
> **Audience**: 高階主管、產品經理
> **Related Architecture**: [Bonus_Calculation_Engine.md](../../architecture/04_Activity_Engine/01_Bonus_Calculation_Engine.md)
...
- [風控策略總覽](../05_Risk_Compliance/01_Risk_Strategy_Overview.md)

### 技術實現

→ **[獎金計算引擎 - 技術架構](../../architecture/04_Activity_Engine/01_Bonus_Calculation_Engine.md)** - 獎金計算規則引擎、Valid Turnover要求追蹤演算法、多幣種處理、遊戲權重矩陣、即時計算優化策略
