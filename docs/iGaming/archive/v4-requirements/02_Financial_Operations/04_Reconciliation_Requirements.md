...
> **相關架構**: [Reconciliation_Technical.md](../../architecture/02_Finance_Service/07_Reconciliation_Technical.md)
> **最後同步**: 2026-02-09
>
...
→ **[技術存儲實現](../../architecture/02_Finance_Service/07_Reconciliation_Technical.md#data-archival)** - PostgreSQL/MySQL 配置、S3 Glacier/Azure Archive 設置、分區策略
...
→ **[時區轉換實現](../../architecture/02_Finance_Service/07_Reconciliation_Technical.md#timezone-handling)** - UTC 轉換算法、時區偏移配置、跨日識別邏輯
...
→ **[支付方式技術規格](../../architecture/02_Finance_Service/07_Reconciliation_Technical.md#payment-methods)** - 3DS 驗證實現、區塊鏈確認次數、MNO 報表解析、鏈上驗證邏輯
...
- [Reconciliation_Technical.md](../../architecture/02_Finance_Service/07_Reconciliation_Technical.md) - 技術實現細節
