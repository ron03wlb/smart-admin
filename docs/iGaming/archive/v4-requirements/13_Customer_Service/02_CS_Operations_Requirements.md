...
> **目標讀者**: 產品經理、客服經理、營運總監
> **相關架構**: [CS_Operations_Architecture.md](../../architecture/13_Customer_Service/02_CS_Operations_Architecture.md)
> **最後同步**: 2026-02-09
...
- [CS_Platform_Requirements.md](01_CS_Platform_Requirements.md) - CS 平台需求
- [CS_Operations_Architecture.md](../../architecture/13_Customer_Service/02_CS_Operations_Architecture.md) - 技術架構
