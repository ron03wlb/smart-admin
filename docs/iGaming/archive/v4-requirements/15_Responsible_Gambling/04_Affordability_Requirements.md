...
> **目標讀者**: 產品經理、合規官
> **相關架構**: [Player_Protection_API.md](../../architecture/15_Responsible_Gambling/04_Player_Protection_API.md)
> **最後同步**: 2026-02-09
...
- [Deposit_Limits_Requirements.md](02_Deposit_Limits_Requirements.md) - 存款限制
- [Self_Exclusion_Requirements.md](01_Self_Exclusion_Requirements.md) - 自我排除
- [Session_Protection_Requirements.md](03_Session_Protection_Requirements.md) - 會話保護
