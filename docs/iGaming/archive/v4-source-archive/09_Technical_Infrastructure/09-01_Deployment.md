...
flowchart TD
    ...
    CLEANUP --> PROMOTE[提升 Blue 為 Green<br/>Relabel: Blue → Green<br/>版本: v4.0.0]
...
### 相關文檔
- [12-03 網關架構](./09-02-01_Gateway_Core.md) - API Gateway
- [12-06 性能監控](./09-06_Performance_Monitoring.md) - APM 集成
