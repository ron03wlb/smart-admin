...
### 系統架構參考
- [05-01 Multi_Tenant_Arch](./06-01_Multi_Tenant.md) - 租戶隔離與金鑰分區
- [05-03 RBAC_Security](../06_Platform_Governance/06-02_RBAC_Permissions.md) - 權限分級脫敏
- [05-04 Audit_System](../06_Platform_Governance/06-03_Audit_Log.md) - PII 存取審計
- [05-06 Approval_Workflow](../06_Platform_Governance/06-04_Approval_Workflow.md) - GDPR 刪除審批流程
...
### 技術基礎設施
<!-- TODO: 待創建文檔 - Week 5-6 -->
<!-- - [07-03-01 Design_Principles](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - API 安全標準 -->
...
**最後更新**: 2026-02-03
**來源文檔**：
- 12-03_Data_Security_Standard.md (301行)
- 12-03-01_Encryption_Strategy.md (284行)
- 12-03-02_Blind_Index_Architecture.md (347行)
- 12-03-03_GDPR_Data_Deletion.md (260行)
