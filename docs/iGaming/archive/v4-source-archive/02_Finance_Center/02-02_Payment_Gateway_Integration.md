...
> ⚠️ **合規提醒**: 支付方式需符合各司法管轄區限制，詳見 [12-06_Payment_Restrictions.md](../12_System_Security/12-06_Payment_Restrictions.md)

- **法幣支付**：
  - 網銀轉帳 (Bank Transfer)
  - 快捷支付 (Credit/Debit Card) - **注意**: UK 2020-04、Australia 2026-04 禁止信用卡博彩
  - 電子錢包 (E-Wallet: LinePay, Momo, GCash)
- **加密貨幣 (Crypto)**：
  - 支援 USDT (TRC20, ERC20), BTC, ETH
  - **自動匯率換算**：由於平台主帳戶通常為法幣，需串接匯率 API (如 Binance/Oanda) 實時計算匯率。
  - **AML 合規**: 加密貨幣需進行錢包地址風險評分，詳見 [12-06_Payment_Restrictions.md](../12_System_Security/12-06_Payment_Restrictions.md)

### 2.1.1 信用卡禁令合規 (Credit Card Ban Compliance)

| 地區 | 生效日期 | 範圍 | 技術要求 |
|------|---------|------|---------|
| **UK** | 2020-04 | 所有博彩 | 阻擋 VISA_CREDIT, MASTERCARD_CREDIT, AMEX |
| **Australia** | 2026-04 | 線上博彩 | 即將生效，需提前準備 |
| **Sweden** | 2025+ | 線上品牌 | 擴展禁令中 |
| **Germany** | 2021 | 所有博彩 | 完全禁止 |

**實現方式**：整合 [JurisdictionRouterService](../06_Platform_Governance/06-07_Multi_Jurisdiction_Framework.md) 動態載入支付方式白名單。
...
### 合規參考
- [12-06_Payment_Restrictions.md](../12_System_Security/12-06_Payment_Restrictions.md) - 信用卡禁令與加密貨幣合規
- [06-07_Multi_Jurisdiction_Framework.md](../06_Platform_Governance/06-07_Multi_Jurisdiction_Framework.md) - 多牌照支付方式配置
- [06-08_UKGC_Compliance.md](../06_Platform_Governance/06-08_UKGC_Compliance.md) - UK 信用卡禁令詳細要求
