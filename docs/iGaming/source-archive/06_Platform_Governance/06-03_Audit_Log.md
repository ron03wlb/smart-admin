...
> **相關文檔**: [09-04 審批工作流系統](./06-04_Approval_Workflow.md) - 高風險操作的 Maker-Checker 審批流程
...
### 配套系統參考
- [09-04 審批工作流系統](./06-04_Approval_Workflow.md) - 審計日誌的審批操作記錄
- [09-01 管理後台RBAC](../06_Platform_Governance/06-02_RBAC_Permissions.md) - 審計日誌的權限控制
- [09-03 數據安全標準](./12-03_Data_Security_Standard.md) - 敏感數據脫敏要求

### 技術架構參考
- [12-01 部署架構](../09_Technical_Infrastructure/09-01_Deployment.md) - Elasticsearch 集群部署
- [07-04 數據管道架構](../10_Platform_Management/10-04_Data_Pipeline_Architecture.md) - Kafka 數據流配置

---

**文檔版本**: 4.0.0 (拆分自 09-02 V2.0)
**最後更新**: 2026-01-27
