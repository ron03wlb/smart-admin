...
> **相關文檔**: [09-02 審計日誌系統](../06_Platform_Governance/06-03_Audit_Log.md) - 所有審批操作的日誌記錄與查詢
...
- [01-01 玩家賬戶系統](../01_Player_Center/01-01_Player_Lifecycle.md) - 玩家數據結構

### 核心依賴
- [02-01 提款風控](../01_Player_Center/01-05_Withdrawal_Risk.md) - 提款審批規則
- [05-01 風控系統](../05_Risk_Control/05-01_Risk_Framework.md) - 風險評分邏輯
- [07-03 通知架構](../10_Platform_Management/10-03_Notification_Architecture.md) - 審批通知實現

### 相關實作
- [11-01 客服平台設計](../13_Customer_Service/13-01_CS_Platform_Design.md) - 客服操作審批（補單、踢線）
- [10-02 配置管理系統](../10_Platform_Management/10-02_Tenant_Configuration.md) - 配置變更審批
- [04-01 活動系統設計](../04_Activity_Center/04-04_Activity_Bonus.md) - 紅利發放審批

### 延伸閱讀
- [06-02 權限與認證](../06_Platform_Governance/06-02_RBAC_Permissions.md) - RBAC 權限控制
- [09-03 API 設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - 審批 API 設計規範
