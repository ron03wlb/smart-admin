...
### 核心依賴
- [07-01 系統層級架構](../06_Platform_Governance/06-01_Multi_Tenant.md) - 多租戶架構、層級設計
- [09-02 審計日誌系統](../06_Platform_Governance/06-03_Audit_Log.md) - 操作日誌記錄

### 業務整合
- [01-01 玩家賬戶系統](../01_Player_Center/01-01_Player_Lifecycle.md) - 玩家權限初始化
- [09-04 審批工作流系統](./06-04_Approval_Workflow.md) - 敏感操作審批

### 技術參考
- [09-03 數據安全標準](./12-03_Data_Security_Standard.md) - 權限數據加密
- [12-03 網關架構](../09_Technical_Infrastructure/09-02-01_Gateway_Core.md) - API 權限驗證

### 延伸閱讀
- [07-02 租戶配置管理](../10_Platform_Management/10-02_Tenant_Configuration.md) - 商戶權限配置
- [11-01 客服平台設計](../13_Customer_Service/13-01_CS_Platform_Design.md) - 客服權限管理
