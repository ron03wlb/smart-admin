...
**相關文檔**: [07-08 流處理架構](./09-08_Stream_Processing_Architecture.md) - §2 Flink CDC
...
- [07-07 性能優化規範](./09-07_Performance_Optimization.md) - §10 JetCache + Redisson 總覽
- [07-08 流處理架構](./09-08_Stream_Processing_Architecture.md) - Flink CDC 緩存失效
- [07-10 成本優化](./09-10_Cost_Optimization.md) - §4.2 Redis 成本優化
