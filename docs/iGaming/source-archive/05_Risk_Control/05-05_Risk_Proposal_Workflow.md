...
**文檔版本**: 4.0.0 (v2.1.0 簡化版)
**最後更新**: 2026-02-02
**維護團隊**: Risk Team & Compliance Team
**前置依賴**:
- [05-03 配置驅動風控系統](./05-03_KYC_AML.md) - 風控提案服務實現
- [05-01 風控系統架構](./05-01_Risk_Framework.md) - 配置驅動規則引擎
...
**維護團隊**: Risk Team & Compliance Team
**相關文檔**:
- [05-03 配置驅動風控系統](./05-03_KYC_AML.md)
- [05-01 風控系統架構](./05-01_Risk_Framework.md)
