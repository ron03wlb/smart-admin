...
| 子文檔 | 主要內容 | 適用角色 |
|-------|---------|---------|
| **[09-03-01 加密策略](./12-03-01_Encryption_Strategy.md)** | AES-256-GCM 加密、密碼雜湊、數據脫敏、金鑰管理 | 後端開發、安全工程師 |
| **[09-03-02 Blind Index 架構](./12-03-02_Blind_Index_Architecture.md)** | 可檢索加密、HMAC 索引、金鑰輪替、效能優化 | 後端開發、數據庫工程師 |
| **[09-03-03 GDPR 數據刪除](./12-03-03_GDPR_Data_Deletion.md)** | Crypto-Shredding、數據遺忘權、合規證明、狀態機 | 安全工程師、法務團隊 |
...
**詳細加密策略**：參見 [09-03-01 加密策略](./12-03-01_Encryption_Strategy.md)
...
**詳細內容**：[09-03-01 §3 存儲加密](./12-03-01_Encryption_Strategy.md#3-存儲加密-column-level-encryption)
...
**詳細內容**：[09-03-02 Blind Index 架構](./12-03-02_Blind_Index_Architecture.md)
...
**完整流程**：[09-03-03 §5 詳細執行流程](./12-03-03_GDPR_Data_Deletion.md#5-詳細執行流程-step-by-step-workflow)
...
**詳細內容**：[09-03-01 §4 密碼雜湊](./12-03-01_Encryption_Strategy.md#4-密碼雜湊-password-hashing)
...
**詳細內容**：[09-03-01 §5 數據脫敏](./12-03-01_Encryption_Strategy.md#5-數據脫敏-data-masking)
...
**詳細內容**：[09-03-03 GDPR 數據刪除](./12-03-03_GDPR_Data_Deletion.md)
...
### 系列文檔（子文檔）
- [09-03-01 加密策略](./12-03-01_Encryption_Strategy.md) - AES-256-GCM、密碼雜湊、金鑰管理
- [09-03-02 Blind Index 架構](./12-03-02_Blind_Index_Architecture.md) - 可檢索加密、HMAC 索引、效能優化
- [09-03-03 GDPR 數據刪除](./12-03-03_GDPR_Data_Deletion.md) - Crypto-Shredding、數據遺忘權、合規證明

### 技術架構參考
- [09-01 管理後台 RBAC](../06_Platform_Governance/06-02_RBAC_Permissions.md) - 權限分級脫敏
- [09-02 審計日誌系統](../06_Platform_Governance/06-03_Audit_Log.md) - PII 存取審計
- [12-05 API 設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - HTTPS 強制要求

### 業務邏輯參考
- [01-01 玩家賬戶系統](../01_Player_Center/01-01_Player_Lifecycle.md) - 密碼重置流程
- [02-01 出金風控](../01_Player_Center/01-05_Withdrawal_Risk.md) - 銀行帳號驗證
- [11-01 客服中台設計](../13_Customer_Service/13-01_CS_Platform_Design.md) - 客服 PII 查詢場景
