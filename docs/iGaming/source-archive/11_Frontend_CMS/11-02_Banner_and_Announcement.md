...
**審批權限** (引用 [09-04 審批工作流系統](../06_Platform_Governance/06-04_Approval_Workflow.md)):
- **運營專員**: 提交 Banner、編輯草稿
...
### 業務邏輯參考
- [04-01 活動系統設計](../04_Activity_Center/04-04_Activity_Bonus.md) - Banner 跳轉活動頁邏輯
- [01-02 VIP 忠誠系統](../01_Player_Center/01-06_VIP_Loyalty.md) - VIP 等級定向規則

### 技術架構參考
- [08-05 本地化系統](./11-07_i18n_Localization.md) - 多語系實作架構
- [09-04 審批工作流系統](../06_Platform_Governance/06-04_Approval_Workflow.md) - Banner 審批流程
- [12-03 網關架構](../09_Technical_Infrastructure/09-02-01_Gateway_Core.md) - CDN 配置與緩存策略
