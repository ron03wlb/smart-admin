...
### 系列文檔
- [08-05-01 i18n 架構與服務設計](./11-07_i18n_Localization.md) - 翻譯服務架構、CDN分發
- [08-05-02 動態內容本地化](./11-08_Dynamic_Content_Localization.md) - JSONB多語言字段、API響應
- [08-05-03 翻譯工作流](./11-09_Localization_Workflow.md) - 狀態機、Crowdin整合

### 技術架構參考
- [12-05 API設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - API 規範
- [12-04 監控體系](../09_Technical_Infrastructure/09-06_Performance_Monitoring.md) - Prometheus/Grafana 監控
- [07-03 通知架構](../10_Platform_Management/10-03_Notification_Architecture.md) - 事件驅動整合
