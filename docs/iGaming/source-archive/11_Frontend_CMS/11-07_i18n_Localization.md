...
flowchart LR
    ...
    subgraph Internal ["🏢 Internal Network (VPC)"]
        direction LR
        Ops("👩‍💻 運營人員"):::actor
        CMS["CMS Service<br/>(Translation/Config)"]:::internal
    ...
    subgraph Storage ["☁️ Origin Layer"]
        OSS[("AWS S3 / GCS<br/>(Source of Truth)")]:::storage
    end

    %% 公網分發 %%
    subgraph Public ["🌍 Public Internet"]
        CDN["CDN Edge Nodes<br/>(Cloudflare/Cloudfront)"]:::edge
...
### 系列文檔
- [08-05-02 動態內容本地化](./11-08_Dynamic_Content_Localization.md) - JSONB多語言字段、API響應策略
- [08-05-03 翻譯工作流](./11-09_Localization_Workflow.md) - 狀態機、Crowdin整合
- [08-05-04 API規格](./11-10_Localization_API.md) - 完整API文檔、監控

### 業務邏輯參考
- [08-01 前端佈局引擎](./11-01_Frontend_Layout_Engine.md) - UI元素整合
- [08-02 Banner管理](./11-02_Banner_&_Announcement.md) - 動態內容多語言

### 技術架構參考
- [12-05 API設計標準](../09_Technical_Infrastructure/09-03-01_Design_Principles.md) - API規範
- [09-02 審計日誌系統](../06_Platform_Governance/06-03_Audit_Log.md) - 翻譯變更審計
