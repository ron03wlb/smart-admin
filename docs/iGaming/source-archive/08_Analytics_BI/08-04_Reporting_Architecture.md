...
>
> **新位置**: [06-01 報表與 BI 架構](../08_Analytics_BI/08-01_Reporting_BI.md)
>
> **遷移原因**: Phase 4 模塊合併計劃（14 模塊 → 8 模塊）
>
> **合併內容**: 本文件全部內容已合併至 06-01，並整合了數據管道架構 (07-04) 的相關內容
>
...
- [05-01 風控系統](../05_Risk_Control/05-01_Risk_Framework.md) - 風控報表數據來源

### 延伸閱讀
- [07-04 數據管道架構](../10_Platform_Management/10-04_Data_Pipeline_Architecture.md) - CDC、ETL 流程
- [12-06 性能監控](../09_Technical_Infrastructure/09-06_Performance_Monitoring.md) - Grafana 儀表板設計
