...
### 系列文檔
- [09-03-01 加密策略](./12-03-01_Encryption_Strategy.md) - AES-256-GCM、金鑰管理
- [09-03-02 Blind Index 架構](./12-03-02_Blind_Index_Architecture.md) - 可檢索加密、索引刪除

### 技術架構參考
- [09-02 審計日誌系統](../06_Platform_Governance/06-03_Audit_Log.md) - 刪除操作審計
- [01-01 玩家賬戶系統](../01_Player_Center/01-01_Player_Lifecycle.md) - 帳號狀態管理
- [07-03 通知架構](../10_Platform_Management/10-03_Notification_Architecture.md) - 刪除事件通知
