...
|--------------|--------------|---------|---------|---------|
| "initialize environment" / "setup" / "start project" | [01-environment-setup.md](./01-environment-setup.md) | Docker installed | PostgreSQL + Redis running | 05, 08, 09 |
...
```mermaid
graph TD
    A[01-environment-setup.md<br/>Environment Initialization] --> B[tdd-workflow.md<br/>TDD Development]
...
- **01-environment-setup.md** - Starting point for all workflows, ensures development environment is ready
- **tdd-workflow.md** - Depends on 01-environment-setup.md, used for daily development
- **github-actions-pipeline.md** - Depends on 01-environment-setup.md, configures CI/CD
...
Workflow: 01-environment-setup.md
...
### ✅ 01-environment-setup.md Completion Check
```bash
...
│   └─ Execute: 01-environment-setup.md
│
├─ "I need to develop new feature" / "need to write code"
│   ├─ Environment initialized?
│   │   ├─ YES → Execute: tdd-workflow.md
│   │   └─ NO → First execute: 01-environment-setup.md, then execute: tdd-workflow.md
│   │
│   └─ Encountered error?
...
**Dependent Rules**:
- [05-postgresql-basics.md](../rules/technology/database/D01-postgresql-basics.md) - Database initialization
- [08-vavr-fundamentals.md](../rules/technology/functional/P01-vavr-fundamentals.md) - Vavr dependency configuration
- [09-mybatis-plus-core.md](../rules/technology/database/D04-mybatis-plus-core.md) - MyBatis Plus configuration
...
### tdd-workflow.md
**Dependent Rules**:
- [01-naming-conventions.md](../rules/foundation/F01-naming-conventions.md) - Test naming
- [08-vavr-fundamentals.md](../rules/technology/functional/P01-vavr-fundamentals.md) - Service returns Option
...
**Dependent Rules**:
- [06-sonarqube-rules.md](../rules/workflows/W01-sonarqube-rules.md) - SonarQube configuration
- [10-architecture-rules.md](../rules/foundation/F04-architecture-rules.md) - ArchUnit tests
...
**Dependent Rules**:
- [01-naming-conventions.md](../rules/foundation/F01-naming-conventions.md) - Checkstyle
- [06-sonarqube-rules.md](../rules/workflows/W01-sonarqube-rules.md) - Quality standards
- [10-architecture-rules.md](../rules/foundation/F04-architecture-rules.md) - ArchUnit
...
**Dependent Rules**:
- [10-architecture-rules.md](../rules/foundation/F04-architecture-rules.md) - Architecture error diagnosis
...
```
Week 1: 01-environment-setup.md + tdd-workflow.md
