...
description: Use when writing integration tests and need test data builders for complex domain objects (Entity, Form, VO), or when agent creates inline test data setup instead of reusable fixture class, or when implementing test data preparation for BaseIntegrationTest subclasses
---
