...
| **SmartAdmin Naming** | `.agent/rules/01-naming-conventions.md` | TestFixture suffix, Chinese field values |
...
**Related Rules**:
- `.agent/rules/10-architecture-rules.md` - @Transactional in Manager layer
- `.agent/rules/01-naming-conventions.md` - TestFixture suffix
