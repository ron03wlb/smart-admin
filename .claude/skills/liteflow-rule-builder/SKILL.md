...
description: Generate LiteFlow rule DSL (EL expressions and QLExpress scripts) from natural language descriptions for complex business workflows. Use when implementing business rule orchestration, approval workflows, validation chains, or migrating from Evrete rules. Triggers when (1) User requests "create LiteFlow chain/rule", (2) User describes a multi-step business workflow, (3) User mentions flow orchestration, conditional logic, or parallel execution, (4) User wants to implement approval/validation flows, (5) Migrating from Evrete to LiteFlow.
---
