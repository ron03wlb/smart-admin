...
description: Use when adding new architecture rules in .agent/rules/*.md or when ArchitectureTest.java needs to enforce new constraints (layer dependencies, annotation restrictions, naming conventions, field injection patterns)
---
