...
public class Level3ProtectConfigService implements SecurityConfigProvider {
  ...
  private void setProp(Level3ProtectConfigForm configForm) {
    ...
    if (configForm.getLoginActiveTimeoutMinutes() != null) {
      ...
      this.loginActiveTimeoutSeconds =
          loginActiveTimeoutSeconds > 0 ? loginActiveTimeoutSeconds : -1;
    }
    ...
    if (configForm.getRegularChangePasswordNotAllowRepeatTimes() != null) {
      this.regularChangePasswordNotAllowRepeatTimes =
          configForm.getRegularChangePasswordNotAllowRepeatTimes();
    }
