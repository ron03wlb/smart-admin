...
public class DataScopeService {
  ...
  public ResponseDTO<List<DataScopeAndViewTypeVO>> dataScopeList() {
    ...
    List<DataScopeAndViewTypeVO> dataScopeAndTypeList =
        SmartBeanUtil.copyList(dataScopeList, DataScopeAndViewTypeVO.class);
    List<DataScopeViewTypeVO> typeList = this.getViewType();
    dataScopeAndTypeList.forEach(
        e -> {
  ...
  public List<DataScopeViewTypeVO> getViewType() {
    ...
    for (DataScopeViewTypeEnum viewTypeEnum : enums) {
      dataScopeViewTypeDTO =
          DataScopeViewTypeVO.builder()
    ...
    Comparator<DataScopeViewTypeVO> comparator =
        (h1, h2) -> h1.getViewTypeLevel().compareTo(h2.getViewTypeLevel());
  ...
  public List<DataScopeDTO> getDataScopeType() {
    ...
    Comparator<DataScopeDTO> comparator =
        (h1, h2) -> h1.getDataScopeTypeSort().compareTo(h2.getDataScopeTypeSort());
