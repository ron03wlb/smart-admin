package net.lab1024.sa.business.category.controller;
 ...
 */
@RestController
@Tag(name = SwaggerTagConst.Business.MANAGER_CATEGORY)
...
public class CategoryController {
  ...
  public ResponseDTO<List<CategoryTreeVO>> queryTree(
      @RequestBody @Valid CategoryTreeQueryForm queryForm) {
