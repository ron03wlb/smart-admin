...
public class ArchitectureTest {
   ...
   *
   * <p>⚠️ OA 模塊特殊約束：禁止調用 Business 模塊 Service，但允許調用 System 模塊 Service（department/employee）
   *
   * <p>排除項：
   *
   * <ul>
   ...
   *   <li>System 模塊 Service - OA 單向依賴 System（僅 department/employee）
   * </ul>
   *
  ...
  static final ArchRule managerShouldNotAccessBusinessService =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAPackage("net.lab1024.sa.business..service..")
          .because("Manager 層禁止調用 Business 模塊 Service 層（嚴格執行，規則：09-manager-layer.md）");
  ...
  // ========== Foundation Package Naming Standards (REMOVED for OA module) ==========
  //
  // Note: The following 3 rules were removed from OA module ArchitectureTest because they
   ...
   *     &#64;Resource private EnterpriseDao enterpriseDao;  // ❌ 禁止
   *     &#64;Resource private EnterpriseManager enterpriseManager;  // ❌ 禁止
   * }
   * </pre>
   *
   * <p>正確示例：
   ...
   * public class EnterpriseService {
   *     private final EnterpriseDao enterpriseDao;  // ✅ 正確
   *     private final EnterpriseManager enterpriseManager;  // ✅ 正確
   * }
   * </pre>
   *
   ...
   * </ul>
   *
   * <p>錯誤示例（EnterpriseService.java）：
   *
   * <pre>
   * import java.util.Optional;  // ❌ 禁止 import
   *
   * private Optional&lt;EnterpriseEntity&gt; queryEnterprise(Long id) {  // ❌ 禁止返回 Optional
   ...
   *
   * private Option&lt;EnterpriseEntity&gt; queryEnterprise(Long id) {  // ✅ 返回 Option
   *     return Option.of(id)
   *         .flatMap(enterpriseId -&gt; Option.of(enterpriseDao.selectById(enterpriseId)))
   ...
   *     public void addEnterpriseTransaction(EnterpriseAddForm form) {  // ✅ 以 Transaction 結尾
   *         // 事務邏輯
   *     }
   * }
   * </pre>
   ...
   * <pre>
   * &#64;Transactional(rollbackFor = Throwable.class)
   * public void addEnterprise(EnterpriseAddForm form) {  // ⚠️ 未以 Transaction 結尾
   *     // 事務邏輯
   * }
   * </pre>
   *
