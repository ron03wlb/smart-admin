...
/**
 * MFA Trusted Device Manager
 *
 * <p>Manager for trusted devices with transactional support. Trusted devices can bypass MFA
 * verification for 30 days. Device fingerprint is generated from IP + User-Agent + Device UUID and
 * hashed with SHA256.
 *
 * <p>Security:
 *
...
public class MfaTrustedDeviceManager {
  ...
  /**
   * Add a new trusted device (transaction method).
   *
   * @param employeeId Employee ID
   * @param deviceFingerprint Device fingerprint (SHA256 hash)
  ...
  /**
   * Remove a trusted device (soft delete, transaction method).
   *
