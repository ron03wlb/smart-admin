...
import net.lab1024.sa.common.core.datamasking.annotation.DataMasking;
import net.lab1024.sa.common.core.datamasking.constant.DataMaskingTypeEnum;
 ...
 * @since 2024/08/01 22:07:27 Copyright <a href="https://1024lab.net">1024创新实验室</a>，Since 2012
 */
@RestController
...
public class AdminDataMaskingDemoController extends SupportBaseController {
  ...
  public ResponseDTO<List<DataVO>> query() {
    ...
    for (int i = 0; i < RandomUtil.randomInt(10, 16); i++) {
      ...
      data.setEmail(
          RandomUtil.randomString(RandomUtil.randomInt(6, 10))
              + "@"
      ...
      data.setCarLicense(
          "豫"
              ...
              + " "
              + RandomStringUtils.randomAlphanumeric(5).toUpperCase(Locale.ROOT));
  ...
  public static class DataVO {
    ...
    @DataMasking private String other;
  }
}
