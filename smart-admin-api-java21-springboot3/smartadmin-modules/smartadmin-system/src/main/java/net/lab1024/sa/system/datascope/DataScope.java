...
import net.lab1024.sa.system.datascope.strategy.AbstractDataScopeStrategy;
...
public @interface DataScope {
  ...
  Class<? extends AbstractDataScopeStrategy> joinSqlImplClazz() default
      AbstractDataScopeStrategy.class;
