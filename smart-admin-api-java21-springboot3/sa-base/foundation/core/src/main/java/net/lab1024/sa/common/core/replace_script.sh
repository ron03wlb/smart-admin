#!/bin/bash
# Create deprecated bridges by replacing implementations with extensions

# SystemErrorCode
cat > code/SystemErrorCode.java << 'JAVA'
...
# UserErrorCode - simplified bridge
cat > code/UserErrorCode.java << 'JAVA'
package net.lab1024.sa.common.core.code;
