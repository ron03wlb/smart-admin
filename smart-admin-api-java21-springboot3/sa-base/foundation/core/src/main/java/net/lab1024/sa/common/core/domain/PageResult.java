...
/**
 * Page Result Bridge Class (DEPRECATED)
 *
 * @deprecated This bridge class is deprecated and will be removed in v4.0.0. Please migrate to
 *     {@link net.lab1024.sa.foundation.domain.response.PageResult} immediately.
 ...
 * @since 3.6.0
 * @see net.lab1024.sa.foundation.domain.response.PageResult New PageResult location
 */
@Slf4j
@Deprecated(since = "3.6.0", forRemoval = true)
public class PageResult<T> extends net.lab1024.sa.foundation.domain.response.PageResult<T> {
  ...
  static {
    if (WARNING_EMITTED.compareAndSet(false, true)) {
      log.warn(
          ...
          ╠════════════════════════════════════════════════════════════════════════════╣
          ║ Class: net.lab1024.sa.common.core.domain.PageResult                       ║
          ║ Use:   net.lab1024.sa.foundation.domain.response.PageResult               ║
          ║                                                                            ║
