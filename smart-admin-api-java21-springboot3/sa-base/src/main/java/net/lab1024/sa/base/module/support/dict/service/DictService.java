...
import net.lab1024.sa.base.module.support.dict.domain.form.DictUpdateForm;
...
public class DictService {
  ...
  public List<DictVO> getAllDict() {
    List<DictEntity> dictEntityList =
        dictDao.selectList(null).stream()
  ...
  public synchronized ResponseDTO<String> addDictData(DictDataAddForm addForm) {
    ...
    DictDataEntity existData =
        dictDataDao.selectByDictIdAndValue(addForm.getDictId(), addForm.getDataValue());
    if (null != existData) {
  ...
  public synchronized ResponseDTO<String> updateDictData(DictDataUpdateForm updateForm) {
    ...
    DictDataEntity existData =
        dictDataDao.selectByDictIdAndValue(updateForm.getDictId(), updateForm.getDataValue());
