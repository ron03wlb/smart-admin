...
dependencies {
    ...
    api(project(":sa-base:infrastructure:web"))        // For SupportBaseController, general JSON serializers
    api(project(":sa-base:infrastructure:mybatis"))    // For MyBatis Plus support
    api(project(":sa-base:infrastructure:swagger"))    // For SwaggerTagConst, SchemaEnum
