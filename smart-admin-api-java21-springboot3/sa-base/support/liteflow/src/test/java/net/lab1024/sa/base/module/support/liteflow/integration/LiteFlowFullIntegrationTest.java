package net.lab1024.sa.base.module.support.liteflow.integration;
...
import net.lab1024.sa.base.module.support.liteflow.dao.LiteFlowScriptDao;
...
import net.lab1024.sa.base.module.support.liteflow.domain.entity.LiteFlowScriptEntity;
...
import net.lab1024.sa.base.module.support.liteflow.domain.form.LiteFlowScriptAddForm;
...
import net.lab1024.sa.base.module.support.liteflow.domain.vo.LiteFlowMonitorOverviewVO;
import net.lab1024.sa.base.module.support.liteflow.manager.LiteFlowChainManager;
import net.lab1024.sa.base.module.support.liteflow.manager.LiteFlowScriptManager;
import net.lab1024.sa.base.module.support.liteflow.service.LiteFlowExecutionService;
import net.lab1024.sa.base.module.support.liteflow.service.LiteFlowMonitorService;
...
class LiteFlowFullIntegrationTest {
  ...
  void testUpdateChain() {
    ...
    // 準備更新表單
    net.lab1024.sa.base.module.support.liteflow.domain.form.LiteFlowChainUpdateForm form =
        new net.lab1024.sa.base.module.support.liteflow.domain.form.LiteFlowChainUpdateForm();
