...
public class VOVariableService extends CodeGenerateBaseVariableService {
  ...
  public Map<String, Object> getInjectVariablesMap(CodeGeneratorConfigForm form) {
    ...
    List<CodeTableField> updateFieldList =
        form.getTableFields().stream()
            .filter(e -> Boolean.TRUE.equals(e.getShowFlag()))
  ...
  public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(
      List<CodeTableField> fields, CodeGeneratorConfigForm form) {
    ...
    for (CodeTableField field : fields) {
      ...
      if (isFile(field.getColumnName(), form)) {
        ...
        packageList.add(
            IMPORT_PREFIX + "net.lab1024.sa.common.json.serializer.FileKeyVoSerializer;");
      }
