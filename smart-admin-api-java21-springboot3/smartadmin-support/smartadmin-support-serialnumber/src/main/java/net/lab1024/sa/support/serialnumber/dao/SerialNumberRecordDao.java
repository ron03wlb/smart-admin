...
public interface SerialNumberRecordDao extends BaseMapper<SerialNumberRecordEntity> {
   ...
   * @return
   */
  Long selectRecordIdBySerialNumberIdAndDate(
      @Param("serialNumberId") Integer serialNumberId, @Param("recordDate") String recordDate);
   ...
   * @return
   */
  List<SerialNumberRecordEntity> query(
      Page page, @Param("queryForm") SerialNumberRecordQueryForm queryForm);
}
