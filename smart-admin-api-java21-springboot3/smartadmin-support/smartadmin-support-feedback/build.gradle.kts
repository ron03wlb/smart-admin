...
dependencies {
    ...
    api(project(":smartadmin-common:smartadmin-common-web"))        // For SupportBaseController, general JSON serializers
    api(project(":smartadmin-common:smartadmin-common-mybatis"))    // For MyBatis Plus support
    api(project(":smartadmin-common:smartadmin-common-swagger"))    // For SwaggerTagConst, SchemaEnum

    // SA Base Support - for FileKey serializers
    api(project(":smartadmin-support:smartadmin-support-file"))  // For FileKeyVoSerializer/Deserializer
