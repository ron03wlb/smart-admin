package net.lab1024.sa.support.operatelog.core;
...
import net.lab1024.sa.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
  ...
  private static final String POINT_CUT =
      "@within(net.lab1024.sa.support.operatelog.annotation.OperateLog) || @annotation(net.lab1024.sa.support.operatelog.annotation.OperateLog)";
  ...
  private OperateLog getAnnotationLog(JoinPoint joinPoint) throws Exception {
    ...
    OperateLog classAnnotation =
        AnnotationUtils.findAnnotation(method.getDeclaringClass(), OperateLog.class);
  ...
  private synchronized void ensureThreadInit() {
