package net.lab1024.sa.support.file.config;

import java.net.URI;
import lombok.Data;
import net.lab1024.sa.support.file.service.FileStorageCloudServiceImpl;
import net.lab1024.sa.support.file.service.FileStorageLocalServiceImpl;
 ...
 *
 * @author 1024创新实验室: 罗伊
 * @since 2019-09-02 23:21:10 Copyright <a href="https://1024lab.net">1024创新实验室</a>
 */
@Data
@Configuration
public class FileConfig implements WebMvcConfigurer {
  ...
  public IFileStorageService initCloudFileService(
      ...
      net.lab1024.sa.support.file.dao.FileDao fileDao) {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    if (MODE_LOCAL.equals(mode)) {
      ...
      registry
          .addResourceHandler(FileStorageLocalServiceImpl.UPLOAD_MAPPING + "/**")
