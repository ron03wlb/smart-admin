package net.lab1024.sa.common.swagger.config;
...
import net.lab1024.sa.common.core.config.SystemEnvironmentConfig;
...
import net.lab1024.sa.common.swagger.customizer.SmartOperationCustomizer;
 ...
 * @since 2020-03-25 22:54:46 Copyright <a href="https://1024lab.net">1024创新实验室</a>
 */
@Slf4j
@Configuration
...
public class SwaggerConfig {
  ...
  public static final List<String> SWAGGER_WHITELIST =
      List.of(
          "/swagger-ui/**",
  ...
  public OpenAPIService openApiBuilder(
    ...
    List<ServerBaseUrlCustomizer> list =
        Lists.newArrayList(
            new ServerBaseUrlCustomizer() {
              @Override
