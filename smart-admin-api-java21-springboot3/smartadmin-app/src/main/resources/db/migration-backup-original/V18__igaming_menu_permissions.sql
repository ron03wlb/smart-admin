...
SELECT '錢包管理', 2, m.menu_id, 1, '/igaming/wallet', 'igaming/wallet/index', 0, 1, 1, 0,
    NULL, NULL, NULL, 0, 1, 1, 1, NOW(), NOW()
FROM t_menu m WHERE m.menu_name = 'iGaming 管理' AND m.tenant_id = 1 AND m.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '錢包管理' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '支付管理' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
FROM t_menu p WHERE p.menu_name = '財務報表' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '遊戲大廳' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '遊戲供應商' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '玩家管理' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '促銷規則' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '紅利管理' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '風控規則' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '風控提案' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
FROM t_menu p WHERE p.menu_name = '風險評分' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '聯盟代理' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
...
WHERE p.menu_name = '信用網路' AND p.tenant_id = 1 AND p.deleted_flag = 0
ON CONFLICT DO NOTHING;
