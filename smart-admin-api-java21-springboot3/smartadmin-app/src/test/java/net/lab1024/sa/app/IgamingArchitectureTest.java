...
public class IgamingArchitectureTest {
  ...
  static final ArchRule igamingLayeredArchitecture =
      layeredArchitecture()
          ...
          .optionalLayer("Consumer")
          .definedBy("..igaming..consumer..")
          .optionalLayer("Job")
          ...
          .optionalLayer("LiteFlowComponent")
          .definedBy("..igaming..component..")
          .optionalLayer("Dao")
          ...
          .mayNotBeAccessedByAnyLayer()
          .whereLayer("Dao")
          .mayOnlyBeAccessedByLayers("Manager", "Service", "Adapter", "LiteFlowComponent")
          .as(
