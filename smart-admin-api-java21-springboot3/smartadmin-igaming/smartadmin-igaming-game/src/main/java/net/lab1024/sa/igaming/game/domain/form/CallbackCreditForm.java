...
/**
 * Form for GP credit callback (win settlement).
 *
 * @author iGaming Team
 * @since 2026-02-18
 */
@Data
public class CallbackCreditForm {
  ...
  @NotNull(message = "payoutAmount cannot be null")
  @DecimalMin(value = "0.0001", message = "payoutAmount must be positive")
  @Digits(integer = 15, fraction = 4, message = "payoutAmount precision exceeded")
