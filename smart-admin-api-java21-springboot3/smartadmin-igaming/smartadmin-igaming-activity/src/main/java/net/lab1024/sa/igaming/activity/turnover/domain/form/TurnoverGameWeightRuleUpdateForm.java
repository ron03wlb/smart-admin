...
/**
 * Form for updating a turnover game weight rule.
 *
 * @author iGaming Team
 * @since 2026-03-12
 */
@Data
public class TurnoverGameWeightRuleUpdateForm {
  ...
  @Schema(description = "Change reason (required for auditing)", example = "調整老虎機權重以符合合規要求")
