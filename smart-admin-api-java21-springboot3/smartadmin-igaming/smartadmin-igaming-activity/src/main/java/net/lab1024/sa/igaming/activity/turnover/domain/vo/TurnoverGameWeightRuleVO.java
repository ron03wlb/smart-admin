...
/**
 * Turnover game weight rule view object.
 *
 * @author iGaming Team
 * @since 2026-03-12
 */
@Data
public class TurnoverGameWeightRuleVO {
  ...
  @Schema(description = "Game category (1-6)")
  private Integer gameCategory;

  @Schema(description = "Weight percentage (0.00 ~ 100.00)")
  private BigDecimal weightPercentage;

  @Schema(description = "Priority (higher number = higher priority)")
