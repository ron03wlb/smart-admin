...
public abstract class AbstractSmartReloadCommand {
  ...
  /** 当前ReloadItem的存储器 */
  private Map<String, String> tagIdentifierMap = new ConcurrentHashMap<>();
   ...
   * @return
   */
  public Map<String, String> getTagIdentifierMap() {
    return Collections.unmodifiableMap(tagIdentifierMap);
  }
  ...
  public SmartReloadObject reloadObject(String tag) {
    ...
    Map<String, SmartReloadObject> reloadObjectMap = smartReloadManager.getReloadObjectMap();
