...
const ChangeLogFormModal = forwardRef<
  { show: (rowData?: ChangeLogVO) => void },
...
>(({ onSuccess }, ref) => {
  ...
  return (
    <Modal
      ...
      maskClosable={false}
    >
      <Form form={form} labelCol={{ span: 5 }} wrapperCol={{ span: 19 }} autoComplete="off">
        ...
        <Form.Item
          ...
          rules={[
            ...
            {
              max: CHANGE_LOG_VALIDATION.VERSION_MAX_LENGTH,
              message: `版本號最多 ${CHANGE_LOG_VALIDATION.VERSION_MAX_LENGTH} 個字符`,
            },
          ]}
        >
        ...
        <Form.Item
          ...
          rules={[
            ...
            {
              max: CHANGE_LOG_VALIDATION.AUTHOR_MAX_LENGTH,
              message: `發布人最多 ${CHANGE_LOG_VALIDATION.AUTHOR_MAX_LENGTH} 個字符`,
            },
          ]}
        >
        ...
        <Form.Item
          ...
          rules={[
            ...
            {
              max: CHANGE_LOG_VALIDATION.LINK_MAX_LENGTH,
              message: `跳轉鏈接最多 ${CHANGE_LOG_VALIDATION.LINK_MAX_LENGTH} 個字符`,
            },
          ]}
        >
        ...
        <Form.Item
          ...
          rules={[
            ...
            {
              max: CHANGE_LOG_VALIDATION.CONTENT_MAX_LENGTH,
              message: `更新內容最多 ${CHANGE_LOG_VALIDATION.CONTENT_MAX_LENGTH} 個字符`,
            },
          ]}
        >
          <TextArea
